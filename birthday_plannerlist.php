...
WHERE planners_designation LIKE 'Birthday Planner'";
...
<body>
    <h1 style="font-size: 60;color:black;text-align:center">Birthday Planner List,you can check necessary information before hiring</h1>
    <table>
        <thead>
            <tr>
                <th>Name</th>
