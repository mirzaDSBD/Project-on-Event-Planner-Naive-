...
$query = "SELECT planners_profile_picture, planners_name, planners_designation,p_id FROM planner_list WHERE planners_designation LIKE 'Wedding Planner' AND level LIKE '3' LIMIT 5";
...
<head>
    ...
    <style>
        ...
        .row1-display {
            background-image: url("Images/Wedding/figma1.jpg");
    ...
    <div class="main1">
        <div class="row1-main1">
            <div class="row1-display">
                <button><a href="wedding_plannerlist.php" style="text-decoration: none;">Learn More</a></button>
            </div>
        </div>
        <div class="row2-main1">
            <h1 style="margin-left:80px;">Most Populer In Wedding Party</h1>
