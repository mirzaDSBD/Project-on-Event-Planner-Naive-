...
$query = "SELECT planners_profile_picture, planners_name, planners_designation,p_id FROM planner_list WHERE planners_designation LIKE 'Birthday Planner' AND level LIKE '3' LIMIT 5";
...
<head>
    ...
    <style>
        ...
        .row1-display {
            ...
            background-image: url("Images/Birthday/made2.png");
...
<body>
    ...
    <div class="main1">
        <div class="row1-main1">
            <div class="row1-display">
                ...
                <button><a href="birthday_plannerlist.php" style="text-decoration: none;">Learn More</a></button>
            </div>
        </div>
        <div class="row2-main1">
            <h1 style="margin-left:80px;">Most Populer In Birthday Party</h1>
    ...
    <h1><strong style="margin-bottom: 0%;margin-left:30px;margin-top:0px">Explore More</strong></h1>
    <div class="main2">
        <div class="advertise">
